...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		while (opcion != 5) {
			...
			String[] salidaE = { "Si" };
			opcion = JOptionPane.showOptionDialog(null, "Elija una opci�n:", "Inicio", JOptionPane.DEFAULT_OPTION,
			...
			default:
				System.out.println("Opci�n no v�lida debe utilizar el boton salir del menu\n");
				break;
			}
		}
	}
